<template>
  <div
    class="fixed bottom-0 left-0 hidden h-[calc(100vh-80px)] w-24 flex-col items-center justify-end border-r bg-black xl:flex"
  >
    <span
      class="mb-8 rotate-180 font-josefin text-sm font-light uppercase leading-none tracking-wider text-ea-green-light [text-orientation:sideways] [writing-mode:vertical-lr]"
